...
class AddParent extends Component
{
    ...
    public $currentStep = 1, // Click Button Form
    ...
    public function firstStepSubmit()
    {
       $this->validate([
            ...
            'Phone_Father'          => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10|max:14',
    ...
    public function secondStepSubmit()
    {
      ...
      // Click Button Return Setp 3
      $this->currentStep = 3;

    }

    // Add Info Parent In Database
    public function submitForm(){
        ...
        try {
            ...
            // Uploaded Img
            // Storing File
            // Open Folder Name By [National_ID_Father]
            // Get Photo Name
            ...
            $this->clearForm(); // Clear All Field Form
            $this->currentStep = 1; // Return To Setp 1
        }
    ...
    public function submitForm_edit(){
        ...
        if ($this->Parent_id){
            ...
            $parent->update([
                ...
                'Passport_ID_Mother'     => $this->Passport_ID_Father,
                'National_ID_Mother'     => $this->National_ID_Father,
                'Phone_Mother'           => $this->Phone_Father,
                'Nationality_Mother_id'  => $this->Nationality_Father_id,
                'Blood_Type_Mother_id'   => $this->Blood_Type_Father_id,
                'Address_Mother'         => $this->Address_Father,
                'Religion_Mother_id'     => $this->Religion_Father_id,
            ]);
